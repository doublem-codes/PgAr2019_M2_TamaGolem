...
public class Matrix {
     ...
     */
    public static int searchMaximum(int[][] matrix) {
     ...
     */
    public static int[][] transposeMatrix(int diagonalIndex, int[][] matrix, boolean invertNumberValue) {
     ...
     */
    public static void printMatrix(int[][] matrix, ArrayList<String> arrayList){
        System.out.println();
        int max = 0;
     ...
     */
    private static void printSpaces(int length, int max, boolean isAfter){
        int numberOfSpaces;
        if(!isAfter) {
     ...
     */
    private static void printDivision(int totalLenght, int lenghtEachBox){
